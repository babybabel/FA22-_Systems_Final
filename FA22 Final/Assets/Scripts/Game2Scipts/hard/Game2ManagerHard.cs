...
public class Game2ManagerHard : MonoBehaviour
{

    public CalamaxController lich;

    public LightClickerHard lightClicker;
    ...
    private void Start()
    {
        lightClicker = GameObject.Find("LightClicker").GetComponent<LightClickerHard>();
    }
